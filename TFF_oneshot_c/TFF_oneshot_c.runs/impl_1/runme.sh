...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/TFF_oneshot_c/TFF_oneshot_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TFF_oneshot_c.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TFF_oneshot_c.tcl -notrace
