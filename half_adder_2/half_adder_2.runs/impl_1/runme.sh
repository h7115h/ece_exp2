...
HD_PWD='C:/Users/user/Desktop/ex2/half_adder_2/half_adder_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_case.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source half_adder_case.tcl -notrace
