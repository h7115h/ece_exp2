...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/mux2b4to1/mux2b4to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2b4to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2b4to1.tcl -notrace
