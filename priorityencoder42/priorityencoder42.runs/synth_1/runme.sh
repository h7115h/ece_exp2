...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/priorityencoder42/priorityencoder42.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priorityencoder42.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priorityencoder42.tcl
