...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/TFF_oneshot2/TFF_oneshot2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TFF_oneshot2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TFF_oneshot2.tcl -notrace
