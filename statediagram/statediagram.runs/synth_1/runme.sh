...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/statediagram/statediagram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log statediagram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source statediagram.tcl
