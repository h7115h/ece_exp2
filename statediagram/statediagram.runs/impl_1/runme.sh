...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/statediagram/statediagram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log statediagram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source statediagram.tcl -notrace
